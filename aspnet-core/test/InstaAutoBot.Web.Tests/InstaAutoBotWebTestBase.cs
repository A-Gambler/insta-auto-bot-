...
{
    public abstract class InstaAutoBotWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static InstaAutoBotWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(InstaAutoBotWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<InstaAutoBotDbContext> action)
        {
            using (var context = IocManager.Resolve<InstaAutoBotDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<InstaAutoBotDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<InstaAutoBotDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<InstaAutoBotDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<InstaAutoBotDbContext, Task<T>> func)
        {
            T result;
